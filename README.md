...
This is the code repository for the BreadBot project I undertook for designing a **barebones** "robot" that's controlled by an IR remote that usually controls your TV.
...
The code provided here is compatible with **ATmega-8L 8PU** running a `12Mhz` clock. Should be fine with higher MCs too.
